...
public import ZhangYeung.Mathlib.MeasureTheory.Measure.Prod

/-!
# Patches to `MeasureTheory.Measure.Real`

Additional lemmas about `Measure.real`, forked from `PFR.Mathlib.MeasureTheory.Measure.Real` in
