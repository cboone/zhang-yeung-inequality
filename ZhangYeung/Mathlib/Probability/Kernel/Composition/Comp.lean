...
public import ZhangYeung.Mathlib.Probability.Kernel.Disintegration

/-!
# Patches to `Probability.Kernel.Composition.Comp`

Introduces `deleteMiddle`, `deleteRight`, and `reverse` operations on three-factor kernels, plus
associated simp lemmas. Forked from `PFR.Mathlib.Probability.Kernel.Composition.Comp` in
