...
public import ZhangYeung.Mathlib.Probability.Kernel.Composition.Comp
public import ZhangYeung.Entropy.Kernel.Basic
...
* `entropy_condKernel_le_entropy_fst` and `entropy_condKernel_le_entropy_snd`: conditioning
  reduces entropy.
* `entropy_triple_add_entropy_le`, `entropy_triple_add_entropy_le'`: kernel submodularity.

## Notations

* `Ik[κ, μ] = Kernel.mutualInfo κ μ`

## References

* [teorth/pfr](https://github.com/teorth/pfr) at rev `80daaf1` — file
  `PFR/ForMathlib/Entropy/Kernel/MutualInfo.lean` that this file is forked from.
-/
