...
- [`ZhangYeung.lean`](ZhangYeung.lean) — project entrypoint; re-exports `ZhangYeung.CopyLemma`, `ZhangYeung.Delta`, `ZhangYeung.EntropyRegion`, `ZhangYeung.Prelude`, `ZhangYeung.Theorem2`, `ZhangYeung.Theorem3`, and `ZhangYeung.Theorem4`.
